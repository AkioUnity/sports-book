<!--betclick/main_12.ctp /eng/live-betting-->
<li>
    ...
    <div class="right pakelti">
        ...
        <a href="<?php echo Router::url(array('language' => Configure::read('Config.language'), 'plugin' => $Event["type"] == Event::TYPE_PREMATCH ? 'events' : null, 'controller' => $Event["type"] == Event::TYPE_PREMATCH ? 'events' : 'live', 'action' => $Event["type"] == Event::TYPE_PREMATCH ? 'display' : 'display_event', $Event["id"])); ?>" class="plus click-add"><?=sprintf("+%d", $Event["markets_count"])?></a>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
</li>