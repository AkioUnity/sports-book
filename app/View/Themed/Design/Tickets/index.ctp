        ...
        <div class="white-in">
            <div class="tgl-content table-cnt open-cell slenkama-lentele">
                    ...
                    <div class="dark-table">
                        ...
                        <br />
                        <a href="<?php echo $this->MyHtml->url(array('language' => Configure::read('Config.language'), 'plugin' => false, 'controller' => 'tickets', 'action' => 'history')); ?>" class="silv-small" style="float: right; margin-right: 15px;">
