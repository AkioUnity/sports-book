                                ...
                                <div class="table table-custom">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <tr>
                                                <td><?php echo __('Highest number of agents can be created under the branch'); ?></td>
                                                <td><?php echo $this->MyForm->input(null, array('value' => $settings['highest_number_of_agents']['value'] != "" ? $settings['highest_number_of_agents']['value'] : __("Unlimited"), 'label' => false, 'disabled' => 'disabled')); ?><span style="font-size: x-small; font-style:italic; padding-left: 10px;"><?php echo __("Lowest amount of money that user must have to place a ticket."); ?></span></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo __('Highest number of users can be created under the agent'); ?></td>
                                                <td><?php echo $this->MyForm->input(null, array('value' => $settings['highest_number_of_users']['value'] != "" ? $settings['highest_number_of_users']['value'] : __("Unlimited"), 'label' => false, 'disabled' => 'disabled')); ?><span style="font-size: x-small; font-style:italic; padding-left: 10px;"><?php echo __("Lowest amount of money that user must have to place a ticket."); ?></span></td>
                                            </tr>
                                            <tr>
