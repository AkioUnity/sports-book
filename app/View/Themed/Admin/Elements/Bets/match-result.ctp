...
<?php echo $this->MyForm->input('bet_name', array("value" => $bet_types[$bet_type], 'disabled' => 'disabled')); ?>
    <table id="table_liquid" class="picksTable" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <input class="input-big" type="hidden" name="data[Bet][name]" type="text" maxlength="255" id="BetPartName" value="Match Result">
            </td>
        </tr>
        <tr>
            <td class="">
        ...
        <tr>
            <td class="">
                <input class="input-big" type="text" name="data[BetPart][1][name]" type="text" maxlength="255" id="BetPartName" value="X" disabled="disabled">
                <input class="input-big" type="hidden" name="data[BetPart][1][name]" type="text" maxlength="255" id="BetPartName"  value="X">
                <input class="input-big" type="hidden" name="data[BetPart][1][line]" type="text" maxlength="255" id="BetPartName"  value="X">
        ...
        <tr>
            <td class="">
                <input class="input-big" type="text" name="data[BetPart][2][name]" type="text" maxlength="255" id="BetPartName" value="2" disabled="disabled">
                <input class="input-big" type="hidden" name="data[BetPart][2][name]" type="text" maxlength="255" id="BetPartName"  value="2">
                <input class="input-big" type="hidden" name="data[BetPart][2][line]" type="text" maxlength="255" id="BetPartName"  value="2">
                <input class="input-big" type="hidden" name="data[BetPart][2][order_id]" type="text" maxlength="255" id="BetPartName"  value="3">
            </td>
            <td class="">
