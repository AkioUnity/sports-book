function CGame(iTotBet) {
    ...
    this._init = function () {
		var data = {
			"data": s_oBetList.getHistory()
		};
		request = $.ajax({
			type: "post",
			url: "/eng/casino/games/greyhoundPlay",
			dataType: "json",
		...
		request.done(function (response, textStatus, jqXHR){
			...
			self.refreshButtonPos(s_iOffsetX, s_iOffsetY);
		});
    };
