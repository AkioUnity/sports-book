function CPaytablePanel(oParentContainer){
    ...
    this._init = function(){
        ...
        var oPaytableText = new createjs.Text(TEXT_PAYTABLE," 44px " +PRIMARY_FONT, "#ff7803");
        oPaytableText.x = CANVAS_WIDTH/2;
        oPaytableText.y = 270;
        ...
        _oButPlay = new CTextButton(CANVAS_WIDTH/2,CANVAS_HEIGHT - 150,s_oSpriteLibrary.getSprite('but_gui'),TEXT_PLAY,PRIMARY_FONT,"#ffffff",50,BUTTON_Y_OFFSET,_oContainer);
