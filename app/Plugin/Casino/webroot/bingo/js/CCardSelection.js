function CCardSelection(iMoney,oParentContainer){
    ...
    this._onButPlay = function(){
		...
		var data = {
			"cards": _iNumCards,
			"balls": _iCurNumBalls,
			"bet": COIN_BETS[_iCurCoinBet],
		};
		request = $.ajax({
			type: "post",
			url: "/eng/casino/games/bingoBuy",
			dataType: "json",
		...
		request.done(function (response, textStatus, jqXHR){
			...
			s_oGame.initGame(_iNumCards,_iCurNumBalls,COIN_BETS[_iCurCoinBet],_iMoney,_iTotBet,_iCurNumBallActivated, response.grids, response.numbers);
		});
    };
