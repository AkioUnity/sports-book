...
class GameSettingsController extends CasinoAppController
{
    ...
    public function admin_keno()
    {
        if (!empty($this->request->data)) {
            if ($this->GameSetting->saveSettings($this->request->data, 'kenoSettings')) {
                $this->Admin->setMessage(__('Settings saved.', true), 'success');
            } else {
                $this->Admin->setMessage(__('Can\'t save settings.', true), 'error');
            }
        ...
        $data = $this->GameSetting->getKenoSettings();
        $this->request->data = $data;
        $this->set('data', $data);
        $this->set('tabs', $this->GameSetting->getTabs($this->request->params));
    }

    public function admin_bingo()
    {
        if (!empty($this->request->data)) {
            if ($this->GameSetting->saveSettings($this->request->data, 'bingoSettings')) {
                $this->Admin->setMessage(__('Settings saved.', true), 'success');
            } else {
                $this->Admin->setMessage(__('Can\'t save settings.', true), 'error');
            }
        ...
        $data = $this->GameSetting->getBingoSettings();
        $this->request->data = $data;
        $this->set('data', $data);
        $this->set('tabs', $this->GameSetting->getTabs($this->request->params));
    }

    public function admin_greyhound()
    {
        if (!empty($this->request->data)) {
            if ($this->GameSetting->saveSettings($this->request->data, 'greyhoundSettings')) {
                $this->Admin->setMessage(__('Settings saved.', true), 'success');
            } else {
                $this->Admin->setMessage(__('Can\'t save settings.', true), 'error');
            }
        ...
        $data = $this->GameSetting->getGreyhoundSettings();
        $this->request->data = $data;
        $this->set('data', $data);
        $this->set('tabs', $this->GameSetting->getTabs($this->request->params));
    }

    public function admin_horse()
    {
        if (!empty($this->request->data)) {
            if ($this->GameSetting->saveSettings($this->request->data, 'horseSettings')) {
                $this->Admin->setMessage(__('Settings saved.', true), 'success');
            } else {
                $this->Admin->setMessage(__('Can\'t save settings.', true), 'error');
            }
        ...
        $data = $this->GameSetting->getHorseSettings();
        $this->request->data = $data;
        $this->set('data', $data);
        $this->set('tabs', $this->GameSetting->getTabs($this->request->params));
    }
