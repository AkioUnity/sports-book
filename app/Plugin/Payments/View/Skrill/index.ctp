...
<div class="blue-box">
    <div class="blue-in">
        ...
        <div class="white-in">
            ...
            <div>
                <img src="<?=$this->Html->url('/theme/Design/img/skrill.png');?>" alt="" class="payments" />
            </div>
            <br />
            ...
            <div class="cent-txt txt-pad">
                ...
                <?php echo $this->Form->input('amount', array('label' => __('Amount', true), 'placeholder' => __('Amount', true),  'type' => 'text',  'class' => 'form-input')); ?>
                <div class="clear"></div>
