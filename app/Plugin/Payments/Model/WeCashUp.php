...
class WeCashUp extends PaymentAppModel
{
    /**
     * Model name
     *
     ...
     * @var string
     */
    public $table = 'payments_wecashup';
     ...
     * @var string
     */
    public $useTable = 'payments_wecashup';
    ...
    public $belongsTo = array(
        'PaymentAppModel'   =>  array(
            ...
            'type'          =>  'INNER',
            'conditions'    =>  array('WeCashUp.payment_app_id = PaymentAppModel.id')
        )
    );
