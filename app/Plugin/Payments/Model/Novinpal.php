...
class Novinpal extends PaymentAppModel
{
    /**
     * Model name
     *
     ...
     * @var string
     */
    public $table = 'payments_novinpal';
     ...
     * @var string
     */
    public $useTable = 'payments_novinpal';
    ...
    public $belongsTo = array(
        'PaymentAppModel'   =>  array(
            ...
            'type'          =>  'INNER',
            'conditions'    =>  array('Novinpal.payment_app_id = PaymentAppModel.id')
        )
    );
