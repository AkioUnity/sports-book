...
class BlockChain extends PaymentAppModel
{
    /**
     * Model name
     *
     ...
     * @var string
     */
    public $table = 'payments_block_chain';
     ...
     * @var string
     */
    public $useTable = 'payments_block_chain';
    ...
    public $belongsTo = array(
        'PaymentAppModel'   =>  array(
            ...
            'type'          =>  'INNER',
            'conditions'    =>  array('BlockChain.payment_app_id = PaymentAppModel.id')
        )
    );
