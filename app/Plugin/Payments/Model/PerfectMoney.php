...
class PerfectMoney extends PaymentAppModel
{
    /**
     * Model name
     *
     ...
     * @var string
     */
    public $table = 'payments_perfect_money';
     ...
     * @var string
     */
    public $useTable = 'payments_perfect_money';
    ...
    public $belongsTo = array(
        'PaymentAppModel'   =>  array(
            ...
            'type'          =>  'INNER',
            'conditions'    =>  array('PerfectMoney.payment_app_id = PaymentAppModel.id')
        )
    );
