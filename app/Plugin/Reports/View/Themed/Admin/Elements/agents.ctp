...
<div class="container">
        ...
        <div class="data">
            <table class="border">
                ...
                <tr>
                    ...
                    <td><?php echo __('%s', 'Agent'); ?></td>
                    <td><?php echo __('%s %s  ( %s %% )', $user["Stats"]["totalCommissions"],  Configure::read('Settings.currency'), Configure::read('Settings.commission'), '%'); ?></td>
                    <td><?php echo __('%.2f %s', $user["Stats"]["totalIncome"], Configure::read('Settings.currency')); ?></td>
                    <td><?php echo __('%.2f %s', $user["Stats"]["totalOutcome"], Configure::read('Settings.currency')); ?></td>
                </tr>
                </tbody>
                <?php endforeach; ?>
                <?php else: ?>
    ...
    <div class="totals">
        <h1><?php echo __('Total commissions %.2f %s', (float) $totalCommissions, Configure::read('Settings.currency')); ?></h1>
    </div>
</div>